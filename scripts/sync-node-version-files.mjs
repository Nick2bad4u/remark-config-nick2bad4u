 ...
 * @returns {string}
 *
 * @throws {TypeError} Throws when `version` is not a string or not `x.y.z`.
 */
 ...
 * }}
 *
 * @throws {TypeError} Throws when arguments are unknown, malformed, or
 *   conflicting.
 */
 ...
 * @returns {void}
 *
 * @throws {RangeError} Throws when `preferredVersion` is below `engines.node`.
 */
